...
\[
 0.1489<p_\infty<0.2000.                            \tag{17}
\]

The upper endpoint is the uniform bound `2 delta/(1+rho)<0.2`.  The
smaller number `0.1981` applies at `r=10` (`rho=0.01`) but is not uniform
as `r` tends to infinity.  The damping estimate below uses the lower
